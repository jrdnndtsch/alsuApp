...
RSpec.describe "project_stories/new", type: :view do
  before(:each) do
    assign(:project_story, ProjectStory.new(
      :media_type => "MyString",
      :description => "MyText",
      :video_link => "MyString",
      :project => nil
  ...
  it "renders new project_story form" do
    render

    assert_select "form[action=?][method=?]", project_stories_path, "post" do
